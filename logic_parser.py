...
from logic_symbols import IDENTITY_SYMBOL, NEGATION_SYMBOL, AND_SYMBOL, OR_SYMBOL, XOR_SYMBOL, IMPLIES_SYMBOL, FOR_ALL_SYMBOL, EXISTS_SYMBOL,RELATION_SYMBOL, FALSE_SYMBOL, TRUE_SYMBOL
"""
Copyright 2022 Marcos Recio
